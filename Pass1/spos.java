	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		try {
			BufferedReader br = new BufferedReader(
					new FileReader("/home/gitanjali/java_programs/pattern/sample.txt"));
			BufferedWriter bw = new BufferedWriter(
					new FileWriter("/home/gitanjali/java_programs/pattern/output.txt"));
			Boolean start = false;
			...
			while ((line = br.readLine()) != null && !end) {
				...
				for (int k = 0; k < tokens.length; k++) {
					...
					case "end":
						...
						/*
						 * if(pooltab_cnt==0) pooltab[pooltab_cnt++]=new pooltable(0,temp); else {
						 * pooltab[pooltab_cnt]=new
						 * pooltable(pooltab[pooltab_cnt-1].first+pooltab[pooltab_cnt-1].total_literals,
						 * total_ltr-pooltab[pooltab_cnt-1].first-1); pooltab_cnt++; }
						 */
						break;
					case "origin":
						pos = 3;
		...
		BufferedReader br = new BufferedReader(new FileReader("/home/gitanjali/java_programs/pattern/output.txt"));
		System.out.println("\n*********Output1.txt****************\n");
		try {
