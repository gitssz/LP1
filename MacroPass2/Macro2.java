...
public class Macro2
{
    public static void main(String[] args) throws IOException
    {
        ...
        BufferedReader br1=new BufferedReader(new FileReader("/home/gitanjali/java_programs/SPOS_LAB/src/practice/MNT.txt"));
        String line;
        ...
        br1=new BufferedReader(new FileReader("/home/gitanjali/java_programs/SPOS_LAB/src/practice/ARG.txt"));
        while((line = br1.readLine())!=null)
        {
        ...
        br1=new BufferedReader(new FileReader("/home/gitanjali/java_programs/SPOS_LAB/src/practice/MDT.txt"));
        while((line = br1.readLine())!=null)
        {
            MDT[mdt_cnt]=new mdt();
        ...
        br1=new BufferedReader(new FileReader("/home/gitanjali/java_programs/SPOS_LAB/src/practice/input.txt"));
        arglist[] actual_parameter=new arglist[10];
        BufferedWriter bw1 = new BufferedWriter(new FileWriter("/home/gitanjali/java_programs/SPOS_LAB/src/practice/output.txt"));
        while((line = br1.readLine())!=null)
        {
